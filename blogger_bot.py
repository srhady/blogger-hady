...
def generate_and_post():
    ...
    # আপনার দেওয়া হুবহু প্রম্পট এখানে বসানো হয়েছে
    prompt = f"""
    ...
    ১. আকার ও গঠন: লেখাটি ৪০০ শব্দের মধ্যে রাখবে। শুরুতে একটি সুন্দর শিরোনাম বোল্ড করে দেবে। কোনো সাব-হেডিং বা পয়েন্ট দেওয়ার দরকার নেই, ২-৩টি প্যারায় সাবলীলভাবে লিখবে।
    ২. ফরম্যাটিং: লেখায় কোনো মার্কডাউন (যেমন ** বা #) ব্যবহার করবে গান্ধ না। লেখাকে বোল্ড করতে চাইলে <b>লেখা</b> এবং ইটালিক করতে চাইলে <i>লেখা</i> ট্যাগ ব্যবহার করবে। 
    ৩. কোরআন: কোরআনের রেফারেন্স দিলে প্রথমে আরবি আয়াতটি (হরকতসহ) লিখবে। এরপর <br><br> ট্যাগ দিয়ে আয়াতের বাংলা অর্থটি <blockquote><i>অর্থ...</i></blockquote> এই ট্যাগে লিখবে। অর্থের নিচেই অবশ্যই <b>(সূরা: নাম, আয়াত: নম্বর)</b> উল্লেখ করবে এবং এর ঠিক নিচে <br><br> ট্যাগ দিয়ে পরবর্তী লেখা শুরু করবে।
    ৪. তাফসির: আয়াতের ব্যাখ্যার জন্য 'তাফসিরে ইবনে কাসীর' বা নির্ভরযোগ্য তাফসিরের রেফারেন্স উল্লেখ করবে।
    ৫. হাদিস: হাদিস ব্যবহার করলে শুধুমাত্র <blockquote><i>হাদিসের অর্থ...</i></blockquote> এই ট্যাগের ভেতরে লিখবে। নিচেই অবশ্যই <b>(সূত্র: হাদিস গ্রন্থের নাম ও নম্বর)</b> উল্লেখ করবে এবং এর ঠিক নিচে <br><br> ট্যাগ দিয়ে পরবর্তী লেখা শুরু করবে।
